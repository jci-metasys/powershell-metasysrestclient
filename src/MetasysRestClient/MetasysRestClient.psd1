#
# Module manifest for module 'MetasysRestClient'
#
#
...
@{
    ...
    NestedModules        = @("metasys-env-vars.ps1", "PasswordManagement.ps1", "build-uri.ps1", "build-request.ps1", "Connect-MetasysAccount.ps1", "Read-ConfigFile.ps1", "constants.ps1", "preferences.ps1", "objects.ps1", "enum-sets.ps1")
    ...
    GUID                 = 'e41b2b5e-efd0-55f6-99d5-a8d74c1b6dd2'
    ...
    "Invoke-MsysGetObjects", 'Invoke-MsysGetObject'
    ...
    AliasesToExport      = 'imm', 'cma', 'imgos', 'imgo'
